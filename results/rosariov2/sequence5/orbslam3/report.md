...
| Mean FPS | 11.28 ± 1.56 |
| Real-time factor (input 15 fps) | 0.752 ± 0.104 |
| CPU mean [%] | 22.5 ± 1.9 |
| CPU peak [%] | 38.8 ± 4.4 |
...
|---|---|---|---|---|
| row | 0.0573 ± 0.0161 | 29 | 22.4 | 3/3 |
| turn | 0.0101 ± 0.0004 | 18 | 3.6 | 3/3 |

> **Segment ATE note (Turn ATE < Row ATE):**  
> Row segments average **22.4 s**; turn segments average **3.6 s**.  
